...
public class Box<T> {
	...
	public <U extends Number> void inspect(U u){
        ...
        System.out.println("\t" + price + " T: " + price.getClass().getName());
        System.out.println("\t" + volume + " T: " + volume.getClass().getName());
        System.out.println("\t" + weight + " T: " + weight.getClass().getName());
    }
