...
public class StudentDAO {
	 ...
	 * @param s_class
	 */
	public StudentDAO(int student_id, String name, int age, double cgpa, int s_class) {
	...
	public String toString() {
		...
		builder.append("\t").append(student_id).append("\t").append(name).append("\t")
				.append(age).append("\t").append(cgpa).append("\t").append(s_class);
